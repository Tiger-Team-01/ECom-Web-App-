		...
		<>
			<div className='top-category'>
				...
				<CardGroup>
					<a href="#Fashion">
					<Card style={card}>
						<Card.Img className='scale' variant='top' src="https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=228&ixid=MnwxfDB8MXxyYW5kb218MHx8ZmFzaGlvbixzaGlydHx8fHx8fDE2Mjk0NzM4NjY&ixlib=rb-1.2.1&q=80&utm_campaign=api-credit&utm_medium=referral&utm_source=unsplash_source&w=381" />

						<Card.Body className='p-0'>
							<div className='flex flex-row p-0 ' style={bb}>
								<Image
								...
								<Image
									src='https://images.unsplash.com/photo-1526887520775-4b14b8aed897?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=500&ixid=MnwxfDB8MXxyYW5kb218MHx8ZmFzaGlvbix3YXRjaHx8fHx8fDE2Mjk0NzM0MjU&ixlib=rb-1.2.1&q=80&utm_campaign=api-credit&utm_medium=referral&utm_source=unsplash_source&w=500'
									thumbnail
									style={img}
								/>
							</div>
					...
					<a href="#Electronics">
					<Card style={card}>
						<Card.Img className='scale' variant='top' src="https://www.online-tech-tips.com/wp-content/uploads/2019/12/electronic-gadgets.jpeg" />
						<Card.Body className='p-0'>
							<div className='flex flex-row p-0' style={bb}>
								<Image
					...
					<a href="#Appliances">
					<Card style={card}>
						<Card.Img className='scale' variant='top' src="https://i0.wp.com/movingtips.wpengine.com/wp-content/uploads/2017/01/appliances.jpg?fit=600%2C360&ssl=1" />
						<Card.Body className='p-0'>
							<div className='p-0' style={bb}>
								<Image
